            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown dropdown-user-profile">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">	<a class="dropdown-item" href="{{route('admin.users.show',['id' => auth()->user()->id ])}}"><i
                                class="bx bx-user"></i><span>Thông tin</span></a>
                        <a class="dropdown-item" href="javascript:;"><i
                                class="bx bx-cog"></i><span>Cài đăt tài khoản</span></a>
                        {{-- <a class="dropdown-item" href="javascript:;"><i
                        ...
                        <form method="post" action="{{ route('auth.logout')}}">
                            @csrf
                            <div class="dropdown-divider mb-0"></div>	<a class="dropdown-item" href="javascript:;" onclick="this.closest('form').submit();return false;"><i class="bx bx-power-off"></i><span>Đăng xuất</span></a>
                        </form>
                    </div>
                </li>
