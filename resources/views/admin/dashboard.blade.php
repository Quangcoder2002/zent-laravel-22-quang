                    ...
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            ...
                            <div class="ml-auto align-self-end">
                                <p class="mb-0 font-14 text-primary"><i class='bx bxs-up-arrow-circle'></i>  <span>1.01% 31 ngày trước</span>
                                </p>
                            </div>
                        </div>
                        <div id="chart1"></div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card radius-15">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <div>
                                <p class="mb-0 font-weight-bold">Lượt truy cập</p>
                                <h2 class="mb-0">409</h2>
                            </div>
                            <div class="ml-auto align-self-end">
                                <p class="mb-0 font-14 text-success"><i class='bx bxs-up-arrow-circle'></i>  <span>0.49% 31 ngày trước</span>
                                </p>
                            </div>
                        </div>
                        <div id="chart2"></div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card radius-15">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <div>
                                <p class="mb-0 font-weight-bold">Số lượt theo dõi trang</p>
                                <h2 class="mb-0">2,346</h2>
                            </div>
                            <div class="ml-auto align-self-end">
                                <p class="mb-0 font-14 text-danger"><i class='bx bxs-down-arrow-circle'></i>  <span>130.68% 31 ngày trước</span>
                                </p>
                            </div>
                        </div>
                        <div id="chart3"></div>
                ...
                <div class="card radius-15">
                    <div class="card-header border-bottom-0">
                        <div class="d-lg-flex align-items-center">
                            <div>
                                <h5 class="mb-lg-0">Lượt truy cập mới và cũ</h5>
                            </div>
                            <div class="ml-lg-auto mb-2 mb-lg-0">
                                <div class="btn-group-round">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-white">Trong tháng</button>
                                        <div class="dropdown-menu">	<a class="dropdown-item" href="javaScript:;">Trong tuần</a>
                                            <a class="dropdown-item" href="javaScript:;">Trong năm</a>
                                        </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card radius-15">
                    <div class="card-body">
                        <div class="d-lg-flex align-items-center">
                            <div>
                                <h5 class="mb-4">Thiết bị truy cập</h5>
                            </div>
                        </div>
                        <div id="chart5"></div>
                    </div>
                    <ul class="list-group list-group-flush mb-0">
                        <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Diện thoại<span class="badge badge-danger badge-pill">26%</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Máy tính<span class="badge badge-primary badge-pill">65%</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Máy tính bảng<span class="badge badge-warning badge-pill">9%</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="card-deck flex-column flex-lg-row">
            <div class="card radius-15">
                <div class="card-body">
                    ...
                    <div class="media align-items-center">
                        <div>
                            <img src="/admin/images/icons/chrome.png" width="35" height="35" alt="" />
                        </div>
                    ...
                    <div class="media align-items-center">
                        <div>
                            <img src="/admin/images/icons/firefox.png" width="35" height="35" alt="" />
                        </div>
                        <div class="media-body ml-3">
                    ...
                    <div class="media align-items-center">
                        <div>
                            <img src="/admin/images/icons/edge.png" width="35" height="35" alt="" />
                        </div>
                        <div class="media-body ml-3">
                    ...
                    <div class="media align-items-center">
                        <div>
                            <img src="/admin/images/icons/opera.png" width="35" height="35" alt="" />
                        </div>
                        <div class="media-body ml-3">
                    ...
                    <div class="media align-items-center">
                        <div>
                            <img src="/admin/images/icons/safari.png" width="35" height="35" alt="" />
                        </div>
                        <div class="media-body ml-3">
