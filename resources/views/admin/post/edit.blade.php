        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <h4 class="mb-0"><a href="{{ route('admin.post.index') }}" class="btn btn-outline radius-30"><i class="fadeIn animated bx bx-arrow-back"></i></a></h4>
                </div>
                <form method="POST" action="{{ route('admin.post.update',['id'=>$post->id]) }}" role="form" enctype="multipart/form-data" novalidate="">
                    @method('PUT')  
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="validationCustom01" value="{{$post->title}}" name="title">
                            @error('title')
