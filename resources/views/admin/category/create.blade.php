        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <a href="{{ route('admin.category.index') }}" class="btn btn-outline radius-30"><i class="fadeIn animated bx bx-arrow-back" data-toggle="tooltip" data-placement="top" data-original-title="Nhấn để trở lại danh sách"></i></a>
                </div>
                <form method="POST" action="{{route('admin.category.store')}}" role="form" enctype="multipart/form-data" novalidate="">
                    @csrf
                    <div class="form-row">
                    ...
                    {{-- <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="custom-file mb-3">
                                <input class="custom-file-input"  id="upload" type="file" name="files" accept=".jpg, .png, image/jpeg, image/png" multiple>
