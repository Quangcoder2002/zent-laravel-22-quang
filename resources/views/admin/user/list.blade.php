...
<div class="card card-default">
  <div class="card-header">
    ...
    <div class="card-tools">
      <a href="{{ route('admin.category.create') }}" class="btn btn-primary">Tạo user mới</a>
    </div>
  </div>
  <!-- /.card-header -->
  <div class="card-body">
